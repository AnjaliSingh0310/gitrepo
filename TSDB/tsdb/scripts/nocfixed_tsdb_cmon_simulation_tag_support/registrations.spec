...
nsl_index_file_var(GroupName2,NumberOfElement2,MonitorType2,VectorPrefix2,MinVectors2,maxVectors2,DeleteInterval2,AddInterVal2,Data2, File=GDFConfig2.txt.seq, indexVar=DV_GDFName2, FirstDataLine=1, EncodeMode=All);
