...
nsl_static_var(Metric_ID:1, subject:3, measure:4, GDF_ID:5, Graph_ID:6, File=tsdb_metrics.txt, Refresh=SESSION, Mode=SEQUENTIAL, FirstDataLine=1, EncodeMode=All);
