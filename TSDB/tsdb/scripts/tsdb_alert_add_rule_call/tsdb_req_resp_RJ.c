...
static Condition_type_th_t cond_ty_threshold[7] = {{0,0,1,1,2,2,0,0,0,5,0},   //Fixed Average
                                                   {1,0,1,1,1,2,1,0,0,1,0},   //Fixed SUM OF EVERY
                                                   {2,0,0.2,0.5,2.1,1.5,1,0,0.8,5,0},   //Fixed MAXIMUM
                                                   {3,0,3.2,99.7,92.1,97.5,1,0,0.5,5,0},   //Fixed MINIMUM
                                                   {4,0,0.2,0.7,0.1,0.5,1,0,0.1,1,0},   //Fixed ANY ONE
...
static Condition_type_change_t cond_ty_change[1] = {{0,0,0,1.0,0.5,2.0,1.0,0,0,0.1,5,0,5,0}};
static Condition_type_anomaly_t cond_ty_anomaly[5] = {{4,0,5,0,1,0,0.1,0,2},
                                                      {4,2,5,1,0,1,0.1,1,2},
                                                      {5,0,5,2,1,0,0.1,2,2},
                                                      {4,4,5,3,0,1,0.1,3,2},
                                                      {5,0,5,4,1,0,0.1,0,2},
