...
extern FlowReturn tsdb_meta_data_pattern_matching();
...
void runlogic()
{
    ...
    NSDL2_RUNLOGIC(NULL, NULL, "Executing sequence block - Block1");
    {
        ...
        NSDL2_RUNLOGIC(NULL, NULL, "Executing flow - tsdb_meta_data_pattern_matching");
        UPDATE_USER_FLOW_COUNT(1)
        tsdb_meta_data_pattern_matching();
    }
