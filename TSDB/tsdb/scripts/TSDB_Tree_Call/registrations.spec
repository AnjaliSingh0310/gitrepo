...
//nsl_static_var(Metric_ID:1, File=data_req_metric_id.seq, Refresh=SESSION, Mode=SEQUENTIAL, FirstDataLine=2, EncodeMode=All);
//nsl_static_var(subject:1,measure:2, File=data_req_metric_name.seq, Refresh=SESSION, Mode=SEQUENTIAL, FirstDataLine=2, EncodeMode=All);
//nsl_static_var(Expand_Level:1,File=tsdb_expand_level.seq, Refresh=SESSION, Mode=SEQUENTIAL, FirstDataLine=1, EncodeMode=All);
//nsl_static_var(subjectP:1,measureP:2, File=data_req_metric_name_pattern.seq, Refresh=SESSION, Mode=SEQUENTIAL, FirstDataLine=2, EncodeMode=All);
